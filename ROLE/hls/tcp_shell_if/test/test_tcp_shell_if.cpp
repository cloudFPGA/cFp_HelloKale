        ...
        case RXP_SEND_NOTIF: // SEND A DATA NOTIFICATION TO [TSIF]
            ...
            if (!soTSIF_Notif.full()) {
                ...
                if (DEBUG_LEVEL & TRACE_TOE_RXP) {
                    printInfo(myRxpName, "Sending notification #%d to [TSIF] (sessId=%d, datLen=%d, dstPort=%d).\n",
