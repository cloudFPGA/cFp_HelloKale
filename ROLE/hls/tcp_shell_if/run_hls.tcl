...
set ipDisplayName  "TCP Shell interface (TSIF)"
...
if { $hlsCSim} {
    ...
    csim_design -argv " 121 10.11.12.13 32768   10"
    csim_design -argv " 122 10.11.12.13 32768   11"
    csim_design -argv " 123 10.11.12.13 32768   12"
    csim_design -argv " 124 10.11.12.13 32768   13"
    csim_design -argv " 125 10.11.12.13 32768   14"
    csim_design -argv " 126 10.11.12.13 32768   15"
    csim_design -argv " 127 10.11.12.13 32768   16"
