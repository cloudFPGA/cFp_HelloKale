...
touch $filename_UDP_ECHO_3_ERROR
grep -A 6 -B 10 "UDP_ECHO_3 ERROR" temporary_file.txt > $filename_UDP_ECHO_3_ERROR
printf "UDP_ECHO_3 ERROR count:        "; grep -c "UDP_ECHO_3 ERROR" $filename_UDP_ECHO_3_ERROR
